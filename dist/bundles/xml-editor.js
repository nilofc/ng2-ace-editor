(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('brace'), require('brace/theme/textmate'), require('brace/mode/xml'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'brace', 'brace/theme/textmate', 'brace/mode/xml', '@angular/forms'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.ng2aceeditor = {}),global.ng.core,null,null,null,global.ng.forms));
}(this, (function (exports,core,brace,textmate,xml,forms) { 'use strict';
